...
export const toLocaleString = (ts: string): string =>
  format(parseISO(ts), DATE_FORMAT);

const fromLocaleString = (ts: string): string =>
  formatISO(parse(ts, DATE_FORMAT, new Date()));
